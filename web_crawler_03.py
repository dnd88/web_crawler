...
url = 'https://comic.naver.com/webtoon/detail.nhn?titleId=662774&no=179&weekday=wed'
...
def merge_img(file_list = file_list, img_unit = 20, quotient = quotient, remainder = 'none'):
    cnt = 0
