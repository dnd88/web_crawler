...
result_name = 'ruinlife'
url = 'https://comic.naver.com/webtoon/detail.nhn?titleId=728619&no=1&weekday=thu'
...
def run_crawler(ep_url, sub_dir):
    ...
    # .은 태그의 클래스를 검색: '.wt_viewer img' : .wt_viewer 클래스 하위에 img 태그들 리스트로 반환
